 ...
 * date:        Thu Jan 22 01:42:21 CET 1998
 * last mod.:                                                                
 * descr.:      This file is an adaption of the GTK "testgtk.c" file by
 *              Peter Mattis for building a Graphical User Interface for
 *              YaccViso. The GUI is currently not yet supported in this
 *              Version. 
 */
...
void button_window (GtkWidget *widget,
	       GtkWidget *button)
{
...
void bbox_widget_destroy (GtkWidget* widget, GtkWidget* todestroy)
{
}

void create_bbox_window (gint  horizontal,
		    char* title, 
		    gint  pos, 
		    gint  spacing,
		    gint  child_w, 
...
void set_toolbar_horizontal (GtkWidget *widget,
			gpointer   data) {
  gtk_toolbar_set_orientation (GTK_TOOLBAR (data), GTK_ORIENTATION_HORIZONTAL);
}

void set_toolbar_vertical (GtkWidget *widget,
		      gpointer   data)
{
  gtk_toolbar_set_orientation (GTK_TOOLBAR (data), GTK_ORIENTATION_VERTICAL);
}

void set_toolbar_icons (GtkWidget *widget,
		   gpointer   data)
{
  gtk_toolbar_set_style (GTK_TOOLBAR (data), GTK_TOOLBAR_ICONS);
}

void set_toolbar_text (GtkWidget *widget,
	          gpointer   data)
{
  gtk_toolbar_set_style (GTK_TOOLBAR (data), GTK_TOOLBAR_TEXT);
}

void set_toolbar_both (GtkWidget *widget,
		  gpointer   data)
{
  gtk_toolbar_set_style (GTK_TOOLBAR (data), GTK_TOOLBAR_BOTH);
}

void set_toolbar_small_space (GtkWidget *widget,
			 gpointer   data)
{
  gtk_toolbar_set_space_size (GTK_TOOLBAR (data), 5);
}

void set_toolbar_big_space (GtkWidget *widget,
		       gpointer   data)
{
  gtk_toolbar_set_space_size (GTK_TOOLBAR (data), 10);
}

void set_toolbar_enable (GtkWidget *widget,
		    gpointer   data)
{
  gtk_toolbar_set_tooltips (GTK_TOOLBAR (data), TRUE);
}

void set_toolbar_disable (GtkWidget *widget,
		     gpointer   data)
{
...
GtkWidget *make_toolbar (GtkWidget *window)
{
  GtkWidget *toolbar;
...
void reparent_label (GtkWidget *widget,
...
void create_about_window ()
{
  ...
  GdkBitmap *mask;
  GtkStyle *style;
  char *aboutString = "\na tool for visualizing yacc grammars\n"
    "Copyleft 1997 by Leon Aaron Kaplan, lkaplan@mips.complang.tuwien.ac.at\n"
    "Assisting professor: Alexander Forst, alex@mips.complang.tuwien.ac.at\n"
    "See the accompanied file 'COPYRIGHT' for copyleft information\n"
    "\n\nPlease report any bugs to the first email address\n\n"
    "For a description of functionality see the accompanied file "
    "docu.ps\n\n";
  ...
  if (!window)
    {
      ...
      gtk_window_set_title(GTK_WINDOW(window), "About yaccviso");
      gtk_container_border_width(GTK_CONTAINER(window), 0);
      gtk_widget_realize(window);
 ...
 * GtkPanes
 */
void create_panes(GtkWidget *window)
{
  GtkWidget *frame;
  GtkWidget *hpaned;
  ...
  gtk_container_border_width(GTK_CONTAINER(hpaned), 5);
  gtk_widget_show(hpaned);

  frame = gtk_frame_new(NULL);
  gtk_frame_set_shadow_type(GTK_FRAME(frame), GTK_SHADOW_IN);
  gtk_widget_set_usize(frame, 400, 600); 
  gtk_paned_add1(GTK_PANED(hpaned), frame);
  gtk_widget_show(frame);

  frame = gtk_frame_new(NULL);
  gtk_frame_set_shadow_type(GTK_FRAME(frame), GTK_SHADOW_IN);
  gtk_widget_set_usize(frame, 600, 600);
...
GtkWidget* create_file_menu(void) {
  ...
  GtkWidget *menuitemParse;
  GtkWidget *menuitemAnalyze;
  GtkWidget *menuitemSave;
  GtkWidget *menuitemDoitall;
  GtkWidget *menuitemExit;
  char *labelOpen =    "Open";
  char *labelParse =   "Parse";
  char *labelAnalyze = "Analyze";
  char *labelSave =    "Save";
  char *labelDoitall = "Do it all!";
  char *labelExit =    "Exit";

  menu = gtk_menu_new();

  menuitemOpen = gtk_menu_item_new_with_label(labelOpen);
  menuitemParse = gtk_menu_item_new_with_label(labelParse);
  menuitemAnalyze = gtk_menu_item_new_with_label(labelAnalyze);
  menuitemSave = gtk_menu_item_new_with_label(labelSave);
  menuitemDoitall = gtk_menu_item_new_with_label(labelDoitall);
  menuitemExit = gtk_menu_item_new_with_label(labelExit);

  gtk_menu_append(GTK_MENU(menu), menuitemOpen);
  gtk_menu_append(GTK_MENU(menu), menuitemParse);
  gtk_menu_append(GTK_MENU(menu), menuitemAnalyze);
  gtk_menu_append(GTK_MENU(menu), menuitemSave);
  gtk_menu_append(GTK_MENU(menu), menuitemDoitall);
  gtk_menu_append(GTK_MENU(menu), menuitemExit);
  gtk_widget_show(menuitemOpen);
  gtk_widget_show(menuitemParse);
  gtk_widget_show(menuitemAnalyze);
  gtk_widget_show(menuitemSave);
  gtk_widget_show(menuitemDoitall);
  gtk_widget_show(menuitemExit);

  gtk_signal_connect(GTK_OBJECT(menuitemExit), "activate",
...
GtkWidget* create_edit_menu(void) {
  GtkWidget *menu;
  GtkWidget *menuitemPreferences;
  char *labelPreferences = "Preferences";

  menu = gtk_menu_new();

  menuitemPreferences = gtk_menu_item_new_with_label(labelPreferences);

  gtk_menu_append(GTK_MENU(menu), menuitemPreferences);

  gtk_widget_show(menuitemPreferences);
  
  return menu;
}


GtkWidget* create_algorithms_menu(void) {
  GtkWidget *menu;
...
GtkWidget* create_help_menu(void) {
  GtkWidget *menu;
  GtkWidget *menuitemAbout;
  GtkWidget *menuitemHelp;
  char *labelAbout = "About";
  char *labelHelp = "Help";

  menu = gtk_menu_new();

  menuitemAbout = gtk_menu_item_new_with_label(labelAbout);
  menuitemHelp = gtk_menu_item_new_with_label(labelHelp);

  gtk_menu_append(GTK_MENU(menu), menuitemAbout);
  gtk_menu_append(GTK_MENU(menu), menuitemHelp);
...
void create_menus(GtkWidget *window) {
  ...
  algorithmsmenu = create_algorithms_menu();

  menuitem = gtk_menu_item_new_with_label ("Algorithms"); 
  gtk_menu_item_set_submenu(GTK_MENU_ITEM (menuitem), algorithmsmenu); 
  gtk_menu_bar_append(GTK_MENU_BAR (menubar), menuitem); 
  gtk_widget_show(menuitem); 
  ...
  box2 = gtk_vbox_new (FALSE, 10);
  gtk_container_border_width (GTK_CONTAINER (box2), 10);
  gtk_box_pack_start (GTK_BOX (menubox), box2, TRUE, TRUE, 0);
  gtk_widget_show (box2);
...
void list_add (GtkWidget *widget,
	  GtkWidget *list)
{
  static int i = 1;
  gchar buffer[64];
...
void list_remove (GtkWidget *widget,
	     GtkWidget *list)
{
  GList *tmp_list;
  GList *clear_list;
...
void color_selection_ok (GtkWidget               *w,
...
void color_selection_changed (GtkWidget *w,
                         GtkColorSelectionDialog *cs)
{
  GtkColorSelection *colorsel;
  gdouble color[4];
...
void label_toggle (GtkWidget  *widget,
	      GtkWidget **label)
{
  if (!(*label))
    {
 ...
 * GtkNotebook
 */
void rotate_notebook (GtkButton   *button,
...
gboolean dnd_drop_destroy_popup (GtkWidget *widget, GtkWindow **window)
{
...
void dnd_drop (GtkWidget *button, GdkEvent *event)
{
  static GtkWidget *window = NULL;
...
void dnd_drag_request (GtkWidget *button, GdkEvent *event)
{
...
static void shape_motion (GtkWidget      *widget, 
...
gint color_idle_func (GtkWidget *preview)
{
  static int count = 1;
  guchar buf[768];
  int i, j, k;
...
void color_preview_destroy (GtkWidget  *widget,
		       GtkWidget **window)
{
...
gint gray_idle_func (GtkWidget *preview)
{
  static int count = 1;
  guchar buf[256];
  int i, j;
...
void gray_preview_destroy (GtkWidget  *widget,
		      GtkWidget **window)
{
 ...
 * Selection Test
 */
void selection_test_received (GtkWidget *list, GtkSelectionData *data)
{
  GdkAtom *atoms;
  GtkWidget *list_item;
  GList *item_list;
...
void selection_test_get_targets (GtkWidget *widget, GtkWidget *list)
{
...
static gint scroll_test_expose (GtkWidget *widget, GdkEventExpose *event,
		    GtkAdjustment *adj)
{
  gint i,j;
...
static void scroll_test_configure (GtkWidget *widget, GdkEventConfigure *event,
		       GtkAdjustment *adj)
{
...
static void scroll_test_adjustment_changed (GtkAdjustment *adj, GtkWidget *widget)
{
...
void timeout_test (GtkWidget *label)
{
  static int count = 0;
...
void start_timeout_test (GtkWidget *widget,
		    GtkWidget *label)
{
  if (!timer)
    {
...
void stop_timeout_test (GtkWidget *widget,
		   gpointer   data)
{
  if (timer)
    {
...
void destroy_timeout_test (GtkWidget  *widget,
		      GtkWidget **window)
{
  destroy_window (widget, window);
...
gint idle_test (GtkWidget *label)
{
  static int count = 0;
  static char buffer[32];
...
void start_idle_test (GtkWidget *widget,
		 GtkWidget *label)
{
  if (!idle)
    {
...
void stop_idle_test (GtkWidget *widget,
		gpointer   data)
{
  if (idle)
    {
...
void destroy_idle_test (GtkWidget  *widget,
		   GtkWidget **window)
{
  destroy_window (widget, window);
...
void test_destroy (GtkWidget  *widget,
	      GtkWidget **window)
{
  destroy_window (widget, window);
  gtk_main_quit ();
...
void create_main_window ()
{
    ...
    gtk_widget_set_name (mainwindow, "yaccviso");
    /*  gtk_widget_set_usize (mainwindow, 200, 400);
